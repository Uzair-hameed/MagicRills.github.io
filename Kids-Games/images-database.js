...
const URDU_IMAGES = {
    'ا': {
        ids: [
            ...
            '1msORDt3iTIy2jWVjapMNi8jhDCLTXvNk',
            '1yZFdi1rzD4YMlxKE_Vs19KuY7vyIZuT_',
    ...
    'آ': {
        ids: [
            '1n3M6PoMHgMmkNezrPnjVfXh-ILhB5Vbd',
            '1MLc816ydlsQQCXmmN8NvBKrTlI8JXYBE',
            '1nUuuAicDLjWU-aOdmCwne1RAOPu0eLxF',
    ...
    'ب': {
        ids: [
            '1kylxXL09CeUR2z2vwBUTCJXu9mFAnAdX',
            '1PSJe3OczLazIz2qohrhCRXAyWh1gdxD-',
            '1xmXcEOpIF19C1h6kGpWeUwkv05nmlp9m',
    ...
    'پ': {
        ids: [
            '1U2sIzQzUcRMkn0bPhJSlpCZ806zdQLbc',
            '1AZA0eFqseIVKI_oZ86X4mK4Py5PnPLzg',
            '1kF856Zq7kGk9ADLlZWeR-QmVJnf3VLSz',
    ...
    'ت': {
        ids: [
            '1koIBFdYV69LA7Q8hbWXipsQIbyyKk9bO',
            '1Z-NOMx_OaoKeVGlgYnBu-QEoElGkybf6',
            '1MnTDH0BzIwo34UU48Xq0vYZnLtnpTHmr',
    ...
    'ٹ': {
        ids: [
            '1J4XwYIyOvwFjPTCPe670-G7y6FRzftgq',
            '1UittBNOLlrxEfvMbpW7r8X7T84qMlTGv',
            '1YZVTb7qY6er014J5n6DhepBqX3Mu011c',
    ...
    'ج': {
        ids: [
            '1RxoZz1USsk6TFrL2iwbzCzD6O9rbcFsa',
            '11HsvqUk06h0H7vmQqEgMHdmjFNOPg_PK',
            '1llIMwlyvf9WjWmDjxXfuD8ouRBA2mnI9',
    ...
    'چ': {
        ids: [
            '1DvwzvT5ZrlXToBdvxgdNVgf2BOvWzM8Z',
            '1ggt5YNF-oGOcjJpewu2_s-OaEiIjYIPx',
            '1iGPRmcpngUQoh4xh0IN3tG4TAsY1Hmpb',
    ...
    'ح': {
        ids: [
            '1K1NAMKMnM0Vfgt71BaEVl188lNBAI3NC',
            '1IVrLZYcSHr_TuVFejFXMdtnbn8q8BOJH',
    ...
    'خ': {
        ids: [
            '1ILVS9BtqRF4aNApLYwsy7LoKRIIEWwO2',
            '1ZoEUTSpQ_BItE9RRXVdP-6H3zMPtjnPf',
            '1F13SbGGFNl1TutYeNVBNpInW_vfp8DpA',
    ...
    'د': {
        ids: [
            '1005rzD1Hk88hKxvp0XI6WTKIVQr_7sk3',
            '1Y_ENdUFryjneIyj7yZZYS4FQ8k7dzPsM',
    ...
    'ڈ': {
        ids: [
            '1jURVEHdhuGb_0nAzamP_wo_XddrxuK31',
    ...
    'ذ': {
        ids: [
            '1hwrD0S25T8i-uPeFQ2jZ6Ej2JOPIsmLk',
            '1wxDQpd8JCLCHO1nuIM_gKvE6Z_FIvxNS',
    ...
    'ر': {
        ids: [
            '1_N2OtIRx47kp52Tkk_CtlNiyMfpdAwjF',
            '1tKOYs4HNekLFWCc-ndD8gcFjvJXjuZsK',
            '1B2RAvdSXzKoChc0vanvAD3ixOmv-pqAf',
    ...
    'ز': {
        ids: [
            '1Yia5WCaxAEiZ0TeYTbMkqTkPvTs91fK-',
            '1pkp6hMB1iqN06aLRgh083KK4A2ECZXhu',
            '1VDgmm94Lpkx-RDkyR-OTDBitAPt8rMUt',
    ...
    'س': {
        ids: [
            '1BGBfqVuJb7xtT2GUhgMQU1zk2E13AOC2',
            '179OP4-ZOzV8FaKzS4FkBqrGOasIaVcRd',
            '1RGc2Sa3vbtO8E1cycviGo5t9eYdtFOah',
    ...
    'ش': {
        ids: [
            '1wUJMd5LQR1rqK7GsE-NkGZePVqz9Zg17',
            '1f7l-KHjsYKtxRHwnCj4cMY0kbh5EZ1Di',
            '17KP_K5O0mzlNELnft6MyUS8sB_khPEIb',
    ...
    'ص': {
        ids: [
            '18pQ2i_5GQoDh2RnMg9_xTNrkanAUT5NB',
            '1RbSYF8fcf_wUw07mOMTMCyzG1nQXhU5b',
            '1uUChh93LIGdigADWVoOKFgYLU62Yof_g',
    ...
    'ض': {
        ids: [
            '1OQ0Wc6lLOpCt5N6f2VZgCobT3KhlNZTe',
    ...
    'ط': {
        ids: [
            '1Usyaszm_W_F0-nGPIcMJYawDGzj2wTkL',
            '1TdMQB88snHYqyOJtethYmyL87rtDzq1W',
            '15N-bVFRwVx8kEiXkw39wVDAhbId2h96A',
    ...
    'ع': {
        ids: [
            '1qPiC5aGvSr59A_HUe1bmtdQUwnGyL7Am',
            '18AUmhEV6KKeRJO_d6SZHFA9qTBwkAvjB',
            '1nZSgIWoseVM5M3yU3q4pf-LHV0Ncvn1n',
    ...
    'غ': {
        ids: [
            '1nkstxswRZj9FHTluYVQGzeg5X10_CLgH',
            '1Ucn4lLa8K9z7ojj7498GlaHaI56i0nTH',
            '11BmVQ6NFvWRURSVTkiu3UHYR9p6sgOws',
    ...
    'ف': {
        ids: [
            '1SEyOHC_Z7RNwwDejAl-CZj5o95eeERnk',
            '1e2r_rVNd8EbrtwK0Qgt04sNQI1VHr6mM',
            '1Q633UiT3x30cZpfh4knlRp2EwYohmheF',
    ...
    'ق': {
        ids: [
            '1WFPLaSIQps9PSO4LkQsSIoMzixLbD3tI',
            '1EYGSFq9Y5AB7qCG1xnbQmJK0IyjasAxQ',
    ...
    'ک': {
        ids: [
            '1dncMYa-Ox8T0Gk7tNfzgbMtLjBjbkucp',
            '1c31h1f4q8Ku_rNS0aqfyfWbl9aXeS2Wh',
            '1OfTuzfsyK12Jpx_beAz7JEUXgXnf5uXO',
    ...
    'گ': {
        ids: [
            '1OWWqzTpi4Bp2m1huGZDJjO-YAcHBnfAu',
            '1_9B6U9qjHxttAVZvQ9ISRgvAz76duonO',
            '1q1eZ1Yb1FoX_loE-YxoT_Hi-eqpM7qKA',
    ...
    'ل': {
        ids: [
            '1bftsVJJujHe_5pgAavymJqusHreg8Tb8',
            '1qKunJ3GSDRoL_cz7DlBb4uaW4fPLTFKh',
            '1oH7N_qI3Oe7M-AvYrxovEn8H6iAydvz3',
    ...
    'م': {
        ids: [
            '1BAeBBWGJzpU4EK0VxuTUYCN-insEhVyB',
            '1foGRhSNFqoF4NPlWA1NyhdnomQc2SY7c',
            '1mfrQ6toeK-Gca08AdsMUBHIayZCzMpsW',
    ...
    'ن': {
        ids: [
            '1xG4NLys54lNLYO8vdTDJf1BDwcDf7NaJ',
            '1JzeI25hzugfWYn3T_F54GcEK2Oe_Soco',
            '1LdOaIy7IgiA1tclkSzK47rr76Bqyl8FD',
    ...
    'و': {
        ids: [
            '1nLc0dnqvPOE0tvo2LUMGkd1K9bTx-PWU',
            '1mwIPBT_ldRm-jbotmAwmnBR3i7YEiQiB',
            '1hB-biOVfjRCnwirGwWdwaxSXelqwl5B7',
    ...
    'ہ': {
        ids: [
            '1yThdbF0QIxQV6mhRWG_oR6zAjKts4aXk',
            '1naD0DJQdBuA_FT4u5fZb99lnk9q3bH2Z',
            '1vvNnJfmOR21sPqDb8R54hkf0a0V7nzEW',
