...
function updateStats() {
    ...
    document.getElementById('wowCount').innerText = reactions.wow;
    document.getElementById('sadCount').innerText = reactions.sad;
    document.getElementById('angryCount').innerText = reactions.angry;
    document.getElementById('laughCount').innerText = reactions.laugh;
    document.getElementById('celebrateCount').innerText = reactions.celebrate;
}
...
function addToHistory(type, text, result) {
    ...
    updateStats();
    showToast(`${type}: ${result}`);
}

function renderHistory() {
    let search = document.getElementById('searchHistory')?.value.toLowerCase() || '';
    let filtered = history.filter(h => h.text.toLowerCase().includes(search) || h.type.toLowerCase().includes(search));
    ...
    container.innerHTML = filtered.map(h => `
        <div class="historyItem" onclick="showToast('${h.text} = ${h.result}')">
            <span><b>${h.type}</b>: ${h.text}</span>
            <span style="color:#888;">${h.result}</span>
        </div>
    `).join('');
}
...
function addReaction(r) {
    ...
    updateStats();
    showToast(`Thanks for ${r} reaction!`);
}

// ========== ALL 46 TOOLS ==========
const tools = [
    // 0: Basic Percentage
    { html: `<div class="tool-card"><h2>🔢 What is X% of Y?</h2><div class="inputGroup"><input type="number" id="a" value="10" placeholder="X %"><span>% of</span><input type="number" id="b" value="200" placeholder="Y"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea"><span id="result">20.00</span></div></div>`,
    ...
    // 1: What Percent
    { html: `<div class="tool-card"><h2>❓ A is what % of B?</h2><div class="inputGroup"><input type="number" id="a" value="50" placeholder="A"><span>is what % of</span><input type="number" id="b" value="200" placeholder="B"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea"><span id="result">25.00</span>%</div></div>`,
    ...
    // 2: Percentage Change
    { html: `<div class="tool-card"><h2>📈 Percentage Change</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Old Value"><span>to</span><input type="number" id="b" value="120" placeholder="New Value"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Change: <span id="result">20.00</span>%</div><div class="smallText">Difference: <span id="diff">20.00</span></div></div>`,
    ...
    // 3: Increase
    { html: `<div class="tool-card"><h2>⬆️ Increase by %</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Original"><span>increase by</span><input type="number" id="b" value="10" placeholder="%"></div><button class="btnCalc btnSuccess" id="calcBtn">+ Increase</button><div class="resultArea">New Value: <span id="result">110.00</span></div><div class="smallText">Difference: <span id="diff">10.00</span></div></div>`,
    ...
    // 4: Decrease
    { html: `<div class="tool-card"><h2>⬇️ Decrease by %</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Original"><span>decrease by</span><input type="number" id="b" value="10" placeholder="%"></div><button class="btnCalc btnDanger" id="calcBtn">- Decrease</button><div class="resultArea">New Value: <span id="result">90.00</span></div><div class="smallText">Difference: <span id="diff">10.00</span></div></div>`,
    ...
    { html: `<div class="tool-card"><h2>🔄 Reverse Percentage</h2><div class="inputGroup"><input type="number" id="a" value="110" placeholder="Final Amount"><span>after</span><input type="number" id="b" value="10" placeholder="%"></div><div class="btnGroup"><button class="btnCalc btnSuccess" id="incBtn">After Increase</button><button class="btnCalc btnDanger" id="decBtn">After Decrease</button></div><div class="resultArea">Original: <span id="result">100.00</span></div><div class="smallText">Difference: <span id="diff">10.00</span></div></div>`,
    ...
    // 6: Discount
    { html: `<div class="tool-card"><h2>🏷️ Discount Calculator</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Price"><span>-</span><input type="number" id="b" value="20" placeholder="Discount %"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">You Pay: $<span id="result">80.00</span></div><div class="smallText">You Save: $<span id="diff">20.00</span></div></div>`,
    ...
    // 7: Tax
    { html: `<div class="tool-card"><h2>📄 Tax Calculator</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Price"><span>+</span><input type="number" id="b" value="13" placeholder="Tax %"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Total: $<span id="result">113.00</span></div><div class="smallText">Tax: $<span id="diff">13.00</span></div></div>`,
    ...
    // 8: GST
    { html: `<div class="tool-card"><h2>💰 GST Calculator</h2><div class="inputGroup"><input type="number" id="a" value="1000" placeholder="Amount"><span>+</span><input type="number" id="b" value="18" placeholder="GST %"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">GST: $<span id="diff">180.00</span></div><div class="smallText">Total: $<span id="result">1180.00</span></div></div>`,
    ...
    // 10: Tip
    { html: `<div class="tool-card"><h2>🍽️ Tip Calculator</h2><div class="inputGroup"><input type="number" id="a" value="50" placeholder="Bill"><input type="number" id="b" value="15" placeholder="Tip %"><input type="number" id="c" value="2" placeholder="People"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Tip: $<span id="diff">7.50</span></div><div class="smallText">Per Person: $<span id="result">28.75</span></div></div>`,
    ...
    // 11: Markup
    { html: `<div class="tool-card"><h2>📈 Markup Calculator</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Cost"><input type="number" id="b" value="25" placeholder="Markup %"></div><button class="btnCalc btnSuccess" id="calcBtn">Markup +</button><div class="resultArea">Selling: $<span id="result">125.00</span></div><div class="smallText">Profit: $<span id="diff">25.00</span></div></div>`,
    ...
    // 12: Markdown
    { html: `<div class="tool-card"><h2>📉 Markdown Calculator</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Cost"><input type="number" id="b" value="25" placeholder="Markdown %"></div><button class="btnCalc btnDanger" id="calcBtn">Markdown -</button><div class="resultArea">Selling: $<span id="result">75.00</span></div><div class="smallText">Loss: $<span id="diff">25.00</span></div></div>`,
    ...
    // 13: Profit Margin
    { html: `<div class="tool-card"><h2>💹 Profit Margin</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Cost"><input type="number" id="b" value="125" placeholder="Price"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Profit: $<span id="diff">25.00</span></div><div class="smallText">Margin: <span id="result">20.00</span>%</div></div>`,
    ...
    // 14: ROI
    { html: `<div class="tool-card"><h2>💵 ROI Calculator</h2><div class="inputGroup"><input type="number" id="a" value="1000" placeholder="Investment"><input type="number" id="b" value="1200" placeholder="Return"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">ROI: <span id="result">20.00</span>%</div></div>`,
    ...
    // 15: CAGR
    { html: `<div class="tool-card"><h2>📊 CAGR Calculator</h2><div class="inputGroup"><input type="number" id="a" value="1000" placeholder="Start"><input type="number" id="b" value="2000" placeholder="End"><input type="number" id="c" value="5" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">CAGR: <span id="result">14.87</span>%</div></div>`,
    ...
    // 16: Salary Increase
    { html: `<div class="tool-card"><h2>💼 Salary Increase</h2><div class="inputGroup"><input type="number" id="a" value="50000" placeholder="Current"><input type="number" id="b" value="10" placeholder="% per year"><input type="number" id="c" value="5" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Future: $<span id="result">80525.50</span></div><div class="smallText">Increase: $<span id="diff">30525.50</span></div></div>`,
    ...
    // 17: EMI
    { html: `<div class="tool-card"><h2>🏦 EMI Calculator</h2><div class="inputGroup"><input type="number" id="a" value="10000" placeholder="Loan"><input type="number" id="b" value="10" placeholder="Rate %"><input type="number" id="c" value="12" placeholder="Months"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">EMI: $<span id="result">879.16</span>/month</div><div class="smallText">Interest: $<span id="diff">549.92</span></div></div>`,
    ...
    // 19: Car Loan
    { html: `<div class="tool-card"><h2>🚗 Car Loan EMI</h2><div class="inputGroup"><input type="number" id="a" value="1000000" placeholder="Amount"><input type="number" id="b" value="9" placeholder="Rate %"><input type="number" id="c" value="5" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">EMI: ₹<span id="result">20758.00</span>/month</div></div>`,
    ...
    // 23: SIP
    { html: `<div class="tool-card"><h2>💰 SIP Calculator</h2><div class="inputGroup"><input type="number" id="a" value="5000" placeholder="Monthly"><input type="number" id="b" value="12" placeholder="Return %"><input type="number" id="c" value="10" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Future: ₹<span id="result">1161697.00</span></div></div>`,
    ...
    // 25: RD
    { html: `<div class="tool-card"><h2>📅 RD Calculator</h2><div class="inputGroup"><input type="number" id="a" value="5000" placeholder="Monthly"><input type="number" id="b" value="7" placeholder="Rate %"><input type="number" id="c" value="5" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Maturity: ₹<span id="result">359000.00</span></div></div>`,
    ...
    // 26: BMI
    { html: `<div class="tool-card"><h2>❤️ BMI Calculator</h2><div class="inputGroup"><input type="number" id="a" value="70" placeholder="Weight (kg)"><input type="number" id="b" value="170" placeholder="Height (cm)"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">BMI: <span id="result">24.22</span></div><div class="smallText">Category: <span id="diff">Normal weight</span></div></div>`,
    ...
    // 28: Fraction
    { html: `<div class="tool-card"><h2>🔢 Fraction to %</h2><div class="inputGroup"><input type="number" id="a" value="3" placeholder="Numerator"><span>/</span><input type="number" id="b" value="4" placeholder="Denominator"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Percentage: <span id="result">75.00</span>%</div><div class="smallText">Decimal: <span id="diff">0.75</span></div></div>`,
    ...
    // 29: Percentage Point
    { html: `<div class="tool-card"><h2>📍 Percentage Point</h2><div class="inputGroup"><input type="number" id="a" value="25" placeholder="First %"><span>to</span><input type="number" id="b" value="30" placeholder="Second %"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Difference: <span id="result">5.00</span> pp</div></div>`,
    ...
    // 30: Multiple %
    { html: `<div class="tool-card"><h2>🔁 Multiple Percentages</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Start"><span>+</span><input type="number" id="b" value="10" placeholder="First %"><span>then</span><input type="number" id="c" value="5" placeholder="Second %"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Final: <span id="result">115.50</span></div></div>`,
    ...
    // 31: Range %
    { html: `<div class="tool-card"><h2>📊 Range Percentage</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Value"><span>between</span><input type="number" id="b" value="50" placeholder="Min"><span>and</span><input type="number" id="c" value="150" placeholder="Max"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Percentage: <span id="result">50.00</span>%</div></div>`,
    ...
    // 32: Finder
    { html: `<div class="tool-card"><h2>🔍 Percentage Finder</h2><div class="inputGroup"><input type="number" id="a" value="75" placeholder="Target %"><span>between</span><input type="number" id="b" value="0" placeholder="Min"><span>and</span><input type="number" id="c" value="100" placeholder="Max"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Value: <span id="result">75.00</span></div></div>`,
    ...
    // 33: Compare
    { html: `<div class="tool-card"><h2>⚖️ Compare Percentages</h2><div class="inputGroup"><input type="number" id="a" value="200" placeholder="Val1"><span>of</span><input type="number" id="b" value="25" placeholder="%1"><span>vs</span><input type="number" id="c" value="150" placeholder="Val2"><span>of</span><input type="number" id="d" value="30" placeholder="%2"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Result1: <span id="r1">50.00</span> | Result2: <span id="r2">45.00</span></div><div class="smallText">Winner: <span id="winner">Result 1</span></div></div>`,
    ...
    // 34: Profit/Loss
    { html: `<div class="tool-card"><h2>💸 Profit/Loss</h2><div class="inputGroup"><input type="number" id="a" value="100" placeholder="Cost Price"><input type="number" id="b" value="120" placeholder="Selling Price"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Profit/Loss: $<span id="result">20.00</span></div><div class="smallText">Percentage: <span id="diff">16.67</span>%</div></div>`,
    ...
    // 35: Simple Interest
    { html: `<div class="tool-card"><h2>💹 Simple Interest</h2><div class="inputGroup"><input type="number" id="a" value="10000" placeholder="Principal"><input type="number" id="b" value="10" placeholder="Rate %"><input type="number" id="c" value="5" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Interest: $<span id="result">5000.00</span></div><div class="smallText">Total: $<span id="diff">15000.00</span></div></div>`,
    ...
    // 36: XIRR
    { html: `<div class="tool-card"><h2>📈 XIRR Calculator</h2><div class="inputGroup"><input type="number" id="a" value="1000" placeholder="Investment"><input type="number" id="b" value="2000" placeholder="Return"><input type="number" id="c" value="3" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">XIRR: <span id="result">26.00</span>%</div></div>`,
    ...
    { html: `<div class="tool-card"><h2>💰 Wealth Calculator</h2><div class="inputGroup"><input type="number" id="a" value="10000" placeholder="Monthly Investment"><input type="number" id="b" value="12" placeholder="Return %"><input type="number" id="c" value="20" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Wealth: ₹<span id="result">9990000.00</span></div></div>`,
    ...
    // 38: Inflation
    { html: `<div class="tool-card"><h2>📊 Inflation Calculator</h2><div class="inputGroup"><input type="number" id="a" value="10000" placeholder="Amount"><input type="number" id="b" value="6" placeholder="Inflation %"><input type="number" id="c" value="10" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Future Value: <span id="result">17908.48</span></div></div>`,
    ...
    // 40: Present Value
    { html: `<div class="tool-card"><h2>📉 Present Value</h2><div class="inputGroup"><input type="number" id="a" value="16105" placeholder="Future Value"><input type="number" id="b" value="10" placeholder="Rate %"><input type="number" id="c" value="5" placeholder="Years"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Present Value: $<span id="result">10000.00</span></div></div>`,
    ...
    // 41: Loan Balance
    { html: `<div class="tool-card"><h2>🏦 Loan Balance</h2><div class="inputGroup"><input type="number" id="a" value="100000" placeholder="Loan Amount"><input type="number" id="b" value="12" placeholder="Total Months"><input type="number" id="c" value="6" placeholder="Months Paid"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Remaining Balance: $<span id="result">50000.00</span></div></div>`,
    ...
    { html: `<div class="tool-card"><h2>💳 Credit Card Interest</h2><div class="inputGroup"><input type="number" id="a" value="50000" placeholder="Due Amount"><input type="number" id="b" value="36" placeholder="Annual %"><input type="number" id="c" value="30" placeholder="Days"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Interest: ₹<span id="result">1479.45</span></div></div>`,
    ...
    // 43: Dividend Yield
    { html: `<div class="tool-card"><h2>📊 Dividend Yield</h2><div class="inputGroup"><input type="number" id="a" value="10" placeholder="Dividend/share"><input type="number" id="b" value="500" placeholder="Price/share"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">Dividend Yield: <span id="result">2.00</span>%</div></div>`,
    ...
    // 44: EPS
    { html: `<div class="tool-card"><h2>💹 Earnings Per Share</h2><div class="inputGroup"><input type="number" id="a" value="1000000" placeholder="Net Profit"><input type="number" id="b" value="100000" placeholder="Shares"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">EPS: ₹<span id="result">10.00</span></div></div>`,
    ...
    // 45: P/E Ratio
    { html: `<div class="tool-card"><h2>📈 Price to Earnings</h2><div class="inputGroup"><input type="number" id="a" value="500" placeholder="Price/share"><input type="number" id="b" value="10" placeholder="EPS"></div><button class="btnCalc" id="calcBtn">Calculate</button><div class="resultArea">P/E Ratio: <span id="result">50.00</span></div></div>`,
...
function renderTool(index) {
    ...
    if (index === 5) {
        ...
        if (calcBtn && tool.calc) setTimeout(() => tool.calc(), 10);
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.reaction').forEach(btn => {
        btn.onclick = () => addReaction(btn.getAttribute('data-r'));
    });
    
    document.querySelectorAll('.shareBtn').forEach(btn => {
        btn.onclick = () => {
            let platform = btn.getAttribute('data-s');
            let url = encodeURIComponent(window.location.href);
            let shareUrl = '';
            if (platform === 'fb') shareUrl = `https://www.facebook.com/sharer/sharer.php?u=${url}`;
            else if (platform === 'tw') shareUrl = `https://twitter.com/intent/tweet?text=Calculator&url=${url}`;
            else if (platform === 'wa') shareUrl = `https://wa.me/?text=Check%20this%20calculator%20${url}`;
            else if (platform === 'li') shareUrl = `https://www.linkedin.com/sharing/share-offsite/?url=${url}`;
